...
- [default](#default) と [1app](#1app)

    下図に示す1箇所にはんだ付けします:
{{% card %}}
![jis_space_footprints](../img/layout/jis_space_footprint.png)
{{% /card %}}
...
- [us_like](#us_like) と [1app_us](#1app_us)
    ...
    下図に示す1箇所にはんだ付けします:
{{% card %}}
![us_space_footprints](../img/layout/us_space_footprint.png)
{{% /card %}}

### エンターキー周辺

- [default](#default)，[split_space](#split_space)，[1app](#1app)，および [1app_split](#1app_split)

    下図に示す4箇所のフットプリントにキースイッチをはんだ付けします:
{{% card %}}
![jis_enter_footprints](../img/layout/jis_enter_footprints.png)
{{% /card %}}
...
{{% card %}}
![us_like_enter_footprints](../img/layout/us_enter_footprints.png)
{{% /card %}}

### 右下のキー周辺

- [default](#default)，[split_space](#split_space)，および [us_like](#us_like)

    下図に示す2箇所のフットプリントにキースイッチをはんだ付けします:
{{% card %}}
![1app_footprints](../img/layout/no_app_footprints.png)
{{% /card %}}
...
- [1app](#1app)，[1app_split](#1app_split)，および [1app_us](#1app_us)
    ...
    下図に示す3箇所のフットプリントにキースイッチをはんだ付けします:
{{% card %}}
![1app_footprints](../img/layout/1app_footprints.png)
{{% /card %}}
...
![default_layout](../img/layout/default.png)
...
![split_space_layout](../img/layout/split_space.png)
...
![us_like_layout](../img/layout/us_like.png)
...
![1app_layout](../img/layout/1app.png)
...
![1app_split_layout](../img/layout/1app_split.png)
...
![1app_us_layout](../img/layout/1app_us.png)
